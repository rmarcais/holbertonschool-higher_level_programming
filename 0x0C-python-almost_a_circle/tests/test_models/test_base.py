...
class TestBaseFromJsonString(unittest.TestCase):
    "Tests of the method from_json_string (class Base)."""
    ...
    def test_from_json_string_empty_rectangle(self):
        """Test with an empty string as arguement."""
